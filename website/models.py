...
class AllUsers(db.Model, UserMixin): #type: ignore
	...
	__mapper_args__ = {'polymorphic_identity':'allusers', 'polymorphic_on':"user_role",}
...
class Comment(db.Model): #type: ignore
	...
	commentator = db.Column(db.Integer, db.ForeignKey('allusers.id', ondelete = "CASCADE"), nullable=False)
